...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="form-card bg-white rounded-xl overflow-hidden border border-gray-200">
            ...
            <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-blue-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-gray-600">Add a new book or stationery item to your inventory</p>
                    </div>
                </div>
            </div>
            ...
            <!-- Form Body -->
            <div class="px-6 py-6">
                <form method="post" action="${pageContext.request.contextPath}/item/add" class="space-y-6">
                    <!-- Item Name -->
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">Enter the name of the book or stationery item</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">Number of items available in inventory</p>
                    </div>
                    ...
                    <div class="flex flex-col-reverse sm:flex-row sm:justify-between sm:space-x-3 space-y-3 sm:space-y-0 pt-4">
                        ...
                        <button type="submit" 
                            ...
                            <i class="ri-save-line mr-2"></i> Add Item
                        </button>
                    </div>
                </form>
            </div>
