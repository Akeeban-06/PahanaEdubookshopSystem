    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <% if (customer != null) { %>
            <div class="form-card bg-white rounded-xl overflow-hidden border border-gray-200">
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-blue-100">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-gray-600">Update the details for <%= customer.getName() %></p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Form Body -->
                <div class="px-6 py-6">
                    <form method="post" action="${pageContext.request.contextPath}/customer/update" class="space-y-6">
                        <!-- Account Number -->
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="text" id="accountNumber" name="accountNumber" 
                                       ...
                                       class="readonly-input block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md sm:text-sm"
                                       placeholder="ACC001">
                            </div>
                            <p class="mt-1 text-xs text-gray-500">
                                <i class="ri-information-line"></i> Account number cannot be modified after creation
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <textarea id="address" name="address" rows="3"
                                          class="input-focus block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                          placeholder="123 Main St, City, Country"><%= customer.getAddress() != null ? customer.getAddress() : "" %></textarea>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col-reverse sm:flex-row sm:justify-between sm:space-x-3 space-y-3 sm:space-y-0 pt-4">
                            ...
                            <button type="submit" 
                                ...
                                <i class="ri-save-line mr-2"></i> Update Customer
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <% } else { %>
            <div class="bg-white shadow rounded-lg overflow-hidden border border-gray-200">
                <div class="px-6 py-6 text-center">
                    ...
                    <p class="text-gray-500 mb-6">The customer you're trying to edit doesn't exist or may have been deleted.</p>
                    <a href="${pageContext.request.contextPath}/customer/" 
                       class="inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
